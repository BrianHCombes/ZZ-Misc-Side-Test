...
lr.w = function(){
  "use strict";
  console.log("lr.URPw,lr.LRPw is: " + lr.URPw + " " + lr.LRPw);
  let longFormArgs = ArgConversionToLongFormGradient(arguments,lr.URPw,lr.LRPw);
  console.log("longFormArgs is: " + JSON.stringify(longFormArgs));
  
  var returnArgs = processArgs(longFormArgs, "width");
...
function ArgConversionToLongFormGradient(){
  ...
  console.log("argArgs from long form is: " + JSON.stringify(argArgs));
  return argArgs;
}
